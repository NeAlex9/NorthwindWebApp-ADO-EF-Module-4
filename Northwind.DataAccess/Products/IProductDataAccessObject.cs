...
namespace Northwind.DataAccess.Products
{
    ...
    public interface IProductDataAccessObject
    {
        ...
        Task<int> InsertProduct(ProductTransferObject product);
        ...
        Task<bool> UpdateProduct(ProductTransferObject product);
        ...
        Task<ProductTransferObject> FindProduct(int productId);
