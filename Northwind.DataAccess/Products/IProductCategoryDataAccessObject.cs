...
namespace Northwind.DataAccess.Products
{
    ...
    public interface IProductCategoryDataAccessObject
    {
        ...
        Task<int> InsertProductCategory(ProductCategoryTransferObject productCategory);
        ...
        Task<bool> UpdateProductCategory(ProductCategoryTransferObject productCategory);
        ...
        Task<ProductCategoryTransferObject> FindProductCategory(int productCategoryId);
